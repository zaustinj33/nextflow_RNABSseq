...
# %%
cutoff_dict = {}
sample_list = ['HFold_rep1', 'HFold_rep2'] #['LF_rep1', 'LF_rep2', 'MF_rep1', 'MF_rep2', 'HF_rep1', 'HF_rep2', 'pLF_rep1', 'pLF_rep2', 'pMF_rep1', 'pMF_rep2', 'pHF_rep1', 'pHF_rep2']
...
with open(os.getcwd()+'/Ginivalues.json', 'w') as convert_file:
