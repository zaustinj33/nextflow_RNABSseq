...
meRanCall -ccr -p 40 -o $2/CallResult/$1/$1_Genome10xCall_Controls.txt -bam $2/result/$1/$1_meRanGh_genomeMap_sorted.bam -f /projects/epigenomicslab/Annotation/Homo_sapiens.GRCh38.dna.primary_assembly.fa -mBQ 30 -gref -rl 150 -cSeqID UnMethylated_Control
